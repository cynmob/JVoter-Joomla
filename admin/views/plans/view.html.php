...
{   
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_JVOTER_TITLE_PLANS'), 'calendar-check-o plan');
        ...
        if ($canDo->get('core.edit.published'))
        {
        ...
        elseif ($canDo->get('core.edit.published'))
        {
